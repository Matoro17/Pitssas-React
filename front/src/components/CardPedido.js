...
class CardPedido extends Component {
  ...
  render() {
    ...
    if (!this.props.pronto && !this.props.enviado) {
      ...
      button = (
        <Button
          onClick={() => this.updatePedidoPronto(this.props.pedidoid)}
          variant="contained"
          color="primary"
        >
          Pedido Pronto
      ...
      button = (
        <Button
          onClick={() => this.updatePedidoEnviado(this.props.pedidoid)}
          variant="contained"
          color="primary"
        >
          Pedido Enviado
          ...
          <Grid container spacing={2}>
            <Grid item xs={8}>
              <p>
                ...
                <br />
                Cliente: {this.state.dados[0].nome}
                <br />
                Bairro: {this.state.dados[0].bairro}
                <br />
